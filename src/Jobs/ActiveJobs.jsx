...
import { Tabs, Tab, Card, CardContent, CardActions, Button, Grid, Modal, Box, TextField, Select, MenuItem, FormControl, InputLabel, Typography } from '@mui/material';
...
console.log(jobCategory,'jobcategory',jobCategory)
